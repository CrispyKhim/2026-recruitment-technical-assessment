...
describe("Task 3", () => {
  describe("GET /summary", () => {
    ...
    // NEW TEST CASE FROM BACKEND README FILE
    it("Success", async () => {
      /** Upload recipes to cookbook */
      const skibidi = {
        type: "recipe",
      ...
      const resp1 = await postEntry(skibidi);
      expect(resp1.status).toBe(200);
      ...
      /** Upload ingredients to cookbook */
      ...
      /** Find the base ingredients for Skibidi Spaghetti */
